<template>
    <v-main class="no-padding report_coach">
        <div>
            <h2 class="text-center">Laporan Daftar Coach</h2>
            <br>
            <br>     
            <v-row class="ml-3">
            ...
            <v-simple-table class="">
                <template v-slot:default>
                    ...
                    <tbody>
                        ...
                        <td v-if="item.total_rate != null" class="text-left">{{ item.total_rate }}</td>
                        <td v-else class="text-left">0</td>
                        <td class="text-left">{{ item.jml_coaching_clinic }}</td>
                        </tr>
                    </tbody>                    
                </template>
            </v-simple-table>
        ...
        <table ref="exportable_table" class="d-none">
                ...
                <template
                    ...
                    >
                        ...
                        <td class="text-left">{{ item.email }}</td>
                        <td class="text-left">{{ item.telp }}</td>
                        <td class="text-left">{{ item.total_rate }}</td>
                        <td class="text-left">{{ item.jml_coaching_clinic }}</td>
                        </tr>                                       
                </template>
            </table>
